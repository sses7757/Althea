...
namespace Althea.Numerics
{
	...
	public static class NumberConvert
	{
		...
		public static bool TryConvert<T1, T2>(T1 x, out T2 y) where T1 : unmanaged, INumber<T1> where T2 : unmanaged, INumber<T2>
		{
		...
		/// <returns>Success or not.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool TryConvertChecked<T1, T2>(T1 x, out T2 y) where T1 : unmanaged, INumber<T1> where T2 : unmanaged, INumber<T2>
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static T2 As<T1, T2>(this T1 x) where T1 : unmanaged, INumber<T1> where T2 : unmanaged, INumber<T2>
		{
		...
		/// <exception cref="NotSupportedException">If the conversion is not available</exception>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static T2 As<T2>(this int x) where T2 : unmanaged, INumber<T2> => As<Int32, T2>(x);
		...
		/// <exception cref="NotSupportedException">If the conversion is not available</exception>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static T2 As<T2>(this long x) where T2 : unmanaged, INumber<T2> => As<Int64, T2>(x);
		...
		/// <exception cref="NotSupportedException">If the conversion is not available</exception>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static T2 As<T2>(this double x) where T2 : unmanaged, INumber<T2> => As<Double, T2>(x);
		...
		/// <exception cref="NotSupportedException">If the conversion is not available</exception>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static int AsInt32<T1>(this T1 x) where T1 : unmanaged, INumber<T1> => As<T1, Int32>(x);
		...
		/// <exception cref="NotSupportedException">If the conversion is not available</exception>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static long AsInt64<T1>(this T1 x) where T1 : unmanaged, INumber<T1> => As<T1, Int64>(x);
		...
		/// <exception cref="NotSupportedException">If the conversion is not available</exception>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static double AsDouble<T1>(this T1 x) where T1 : unmanaged, INumber<T1> => As<T1, Double>(x);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static T ToReal<T>(this T x) where T : unmanaged, INumber<T> => (x + T.Conjugate(x)) / (T.One + T.One);
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static T ToImag<T>(this T x) where T : unmanaged, INumber<T> => (x - T.Conjugate(x)) / (T.One + T.One);
	}
	#endregion
}
