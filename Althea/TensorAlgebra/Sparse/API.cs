...
namespace Althea.TensorAlgebra.Sparse
{
	...
	public interface IAbstractApi : IAbstractRuntimeApi<IAbstractApi>
	{
		...
		/// <summary>
		/// When implemented by a derived class, reshape the sparse tensor <paramref name="source"/> to the given size in <paramref name="destination"/> and output a <paramref name="destination"/>.
		/// </summary>
		/// <typeparam name="T">Any unmanaged number as the data type</typeparam>
		/// <typeparam name="TInd1">Any integral-typed unmanaged number as the input index type</typeparam>
		/// <typeparam name="TInd2">Any integral-typed unmanaged number as the output index type</typeparam>
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <remarks>If size in <paramref name="destination"/> is the same as <paramref name="source"/>'s size, this method shall simply returns default</remarks>
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> or <paramref name="newSize"/> is invalid</exception>
		/// <exception cref="ArgumentException">If size in <paramref name="destination"/> is not a valid reshape size</exception>
		[AbstractApiMethod]
		public abstract bool Reshape<T, TInd1, TInd2, TS1, TS2, TSInd1, TSInd2>(ISparseArray<T, TInd1, TS1, TSInd1> source, ref SparseArrayWrapper<T, TInd2, TS2, TSInd2> destination) where T : unmanaged, INumber<T> where TInd1 : unmanaged, IBinaryInteger<TInd1> where TS1 : class, IStorage<T, TS1> where TSInd1 : class, IStorage<TInd1, TSInd1> where TInd2 : unmanaged, IBinaryInteger<TInd2> where TS2 : class, IStorage<T, TS2> where TSInd2 : class, IStorage<TInd2, TSInd2>;
		...
		/// <c><paramref name="destination"/> = <paramref name="scalar"/> * contract(<paramref name="opLeft"/>(<paramref name="left"/>), <paramref name="opRight"/>(<paramref name="right"/>)</c>.
		/// </summary>
		/// <typeparam name="T">Any unmanaged number as the data type</typeparam>
		/// <typeparam name="TInd1">Any integral-typed unmanaged number as the first input index type</typeparam>
		/// <typeparam name="TInd2">Any integral-typed unmanaged number as the second input index type</typeparam>
		...
		[AbstractApiMethod]
		public abstract bool Contract<T, TInd1, TInd2, TInd3, TS1, TS2, TS3, TSInd1, TSInd2, TSInd3>(T scalar, ISparseArray<T, TInd1, TS1, TSInd1> left, UnaryOperation opLeft, ISparseArray<T, TInd2, TS2, TSInd2> right, UnaryOperation opRight, TensorContractInfo info, ref SparseArrayWrapper<T, TInd3, TS3, TSInd3> destination) where T : unmanaged, INumber<T> where TInd1 : unmanaged, IBinaryInteger<TInd1> where TS1 : class, IStorage<T, TS1> where TSInd1 : class, IStorage<TInd1, TSInd1> where TInd2 : unmanaged, IBinaryInteger<TInd2> where TS2 : class, IStorage<T, TS2> where TSInd2 : class, IStorage<TInd2, TSInd2> where TInd3 : unmanaged, IBinaryInteger<TInd3> where TS3 : class, IStorage<T, TS3> where TSInd3 : class, IStorage<TInd3, TSInd3>;
	}
}