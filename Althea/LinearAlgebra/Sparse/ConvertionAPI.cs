...
namespace Althea.LinearAlgebra.Sparse
{
	...
	public abstract partial class AbstractApi : AbstractApiSelector
	{
		...
		protected abstract bool IsSupportedSparseVector<T>(ISparseVector<T> vector) where T : unmanaged, INumber<T>;
		...
		protected abstract bool IsSupportedSparseMatrix<T>(ISparseMatrix<T> matrix) where T : unmanaged, INumber<T>;
		...
		public static void VectorSetValuesAt<T, TInd>(Storage<T> x, T value, Storage<TInd> positions) where T : unmanaged, INumber<T> where TInd : unmanaged
		{
		...
		public static void VectorSparseToDense<T>(ISparseVector<T> x, Storage<T> y) where T : unmanaged, INumber<T>
		{
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		public static void VectorGatherValuesAt<T>(Storage<T> x, ISparseVector<T> y) where T : unmanaged, INumber<T>
		{
		...
		public static SparseArrayWrapper<T> VectorDenseToSparse<T>(Storage<T> x, SparseVectorFormat format, float threshold = 0) where T : unmanaged, INumber<T>
		{
		...
		public static SparseArrayWrapper<T> SparseVectorToMatrix<T>(ISparseVector<T> vector, long rows, SparseMatrixFormat format) where T : unmanaged, INumber<T>
		{
		...
		/// <param name="format">The desired <see cref="SparseVectorFormat"/> of the target sparse vector, can be anatomic</param>
		/// <returns>The created new <see cref="SparseArrayWrapper{T}"/> with format fitting <paramref name="format"/> and desired properties (the length is the product of <see cref="IMatrixMetric.NRows"/> and <see cref="IMatrixMetric.NCols"/>)</returns>
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="ArgumentNullException">If <paramref name="matrix"/> is null or invalid</exception>
		public static SparseArrayWrapper<T> SparseMatrixToVector<T>(ISparseMatrix<T> matrix, SparseVectorFormat format) where T : unmanaged, INumber<T>
		{
		...
		public static void MatrixSparseToDense<T>(ISparseMatrix<T> source, Storage<T> destination, long ld) where T : unmanaged, INumber<T>
		{
		...
		/// <summary>
		/// Convert the given dense matrix <paramref name="source"/> to a sparse matrix of the given <paramref name="format"/>.
		/// </summary>
		...
		public static SparseArrayWrapper<T> MatrixDenseToSparse<T>(long m, long n, Storage<T> source, long ld, SparseMatrixFormat format, float threshold = 0) where T : unmanaged, INumber<T>
		{
		...
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="threshold"/> is less than 0</exception>
		public static SparseArrayWrapper<T> MatrixSparsePrune<T>(ISparseMatrix<T> source, float threshold) where T : unmanaged, INumber<T>
		{
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> is null or invalid</exception>
		public static SparseArrayWrapper<T> MatrixSparseFormatConvert<T>(ISparseMatrix<T> source, SparseMatrixFormat format, IOtherInfo? otherInfo = null) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = source.Storage.LocationDescription;
			SparseArrayWrapper<T> result = default;
			bool success = false;
		...
		public static SparseArrayWrapper<T> MatrixSparseReshape<T>(ISparseMatrix<T> source, long newNRows) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = source.Storage.LocationDescription;
			SparseArrayWrapper<T> result = default;
			bool success = false;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="positions"/> is null or invalid</exception>
		protected abstract bool VectorSetValuesAt_<T, TInd>(Storage<T> x, T value, Storage<TInd> positions) where T : unmanaged, INumber<T> where TInd : unmanaged;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		protected abstract bool VectorSparseToDense_<T>(ISparseVector<T> x, Storage<T> y) where T : unmanaged, INumber<T>;
		...
		/// <remarks>This is equivalent to converting dense vector to sparse vector when the sparsity is known</remarks>
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		protected abstract bool VectorGatherValuesAt_<T>(Storage<T> x, ISparseVector<T> y) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="threshold"/> is less than 0</exception>
		protected abstract bool VectorDenseToSparse_<T>(Storage<T> x, SparseVectorFormat format, out SparseArrayWrapper<T> target, float threshold = 0) where T : unmanaged, INumber<T>;
		#endregion
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="vector"/> is null or invalid</exception>
		protected abstract bool SparseVectorToMatrix_<T>(ISparseVector<T> vector, long rows, SparseMatrixFormat format, out SparseArrayWrapper<T> target) where T : unmanaged, INumber<T>;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="matrix"/> is null or invalid</exception>
		protected abstract bool SparseMatrixToVector_<T>(ISparseMatrix<T> matrix, SparseVectorFormat format, out SparseArrayWrapper<T> target) where T : unmanaged, INumber<T>;
		#endregion
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> or <paramref name="destination"/> is null or invalid</exception>
		protected abstract bool MatrixSparseToDense_<T>(ISparseMatrix<T> source, Storage<T> destination, long ld) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="threshold"/> is less than 0 or <paramref name="format"/> is not atomic</exception>
		protected abstract bool MatrixDenseToSparse_<T>(long m, long n, Storage<T> source, long ld, SparseMatrixFormat format, out SparseArrayWrapper<T> target, float threshold = 0) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="threshold"/> is less than 0</exception>
		protected abstract bool MatrixSparsePrune_<T>(ISparseMatrix<T> source, float threshold, out SparseArrayWrapper<T> target) where T : unmanaged, INumber<T>;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> is null or invalid</exception>
		protected abstract bool MatrixSparseFormatConvert_<T>(ISparseMatrix<T> source, SparseMatrixFormat format, out SparseArrayWrapper<T> target, IOtherInfo? otherInfo = null) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="source"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="newNRows"/> is out of range</exception>
		protected abstract bool MatrixSparseReshape_<T>(ISparseMatrix<T> source, long newNRows, out SparseArrayWrapper<T> target) where T : unmanaged, INumber<T>;
		#endregion
