...
namespace Althea.LinearAlgebra.Sparse
{
	...
	public abstract partial class AbstractApi : AbstractRuntimeApi
	{
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		public static void VectorSparseDotDense<T>(bool conjX, ISparseVector<T> x, Storage<T> y, out T dot) where T : unmanaged;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		public static void VectorSparseDotSparse<T>(bool conjX, ISparseVector<T> x, ISparseVector<T> y, out T dot) where T : unmanaged;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		public static void VectorSparseAddSparse<T>(ISparseVector<T> x, ISparseVector<T> y, ISparseVector<T> target, SparseVectorFormat format = FormatExtension.VectorAny, DelegateCreateMatrixNew<T>? createFunc = null) where T : unmanaged;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="x"/> or <paramref name="y"/> or <paramref name="M"/> is null or invalid</exception>
		public static void MatrixDenseMultiplyVectorSparse<T>(MatrixOperation op, T α, long m, long n, Storage<T> M, ISparseVector<T> x, T β, Storage<T> y) where T : unmanaged, IEquatable<T>;
		...
		/// <param name="M">The preallocated input/output sparse matrix with <c><see cref="ISparseArray{T}.NStored"/> = <paramref name="x"/>.<see cref="ISparseArray{T}.NStored">NStored</see> * <paramref name="y"/>.<see cref="ISparseArray{T}.NStored">NStored</see></c></param>
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="x"/> or <paramref name="y"/> or <paramref name="M"/> is null or invalid</exception>
		/// <exception cref="ArgumentException">If <paramref name="M"/> has wrong number of non-zero elements</exception>
		public static void VectorSparseOuter<T>(bool conjY, T α, ISparseVector<T> x, ISparseVector<T> y, T β, ISparseMatrix<T> M) where T : unmanaged, IEquatable<T>;
		#endregion
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If both <paramref name="A"/> and <paramref name="B"/> are null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If both <paramref name="α"/> and <paramref name="β"/> are 0</exception>
		public static void MatrixSparseAddSparse<T>(MatrixOperation opA, MatrixOperation opB, T α, ISparseMatrix<T>? A, T β, ISparseMatrix<T>? B, out ISparseMatrix<T> target, SparseMatrixFormat format = FormatExtension.MatrixAny, DelegateCreateMatrixNew<T>? createFunc = null) where T : unmanaged, IEquatable<T>;
		...
		public static void MatrixSparseMultiplySparse<T>(MatrixOperation opA, MatrixOperation opB, T α, ISparseMatrix<T> A, ISparseMatrix<T> B, T β, ISparseMatrix<T>? C, out ISparseMatrix<T> target, SparseMatrixFormat format = FormatExtension.MatrixAny, DelegateCreateMatrixNew<T>? createFunc = null) where T : unmanaged, IEquatable<T>;
		...
		public static void MatrixSparseKronecker<T>(ISparseMatrix<T> A, ISparseMatrix<T> B, out ISparseMatrix<T> target, SparseMatrixFormat format = FormatExtension.MatrixAny, DelegateCreateMatrixNew<T>? createFunc = null) where T : unmanaged;
		#endregion

		#region index only
		/// <summary>
		/// When implemented by a derived class, find the minimum and the maximum values of the given <b>sorted</b> integer-typed array <paramref name="array"/>.
		/// </summary>
		...
		public static void IndexMinMax<TInd>(Storage<TInd> array, out TInd min, out TInd max) where TInd : unmanaged;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="array"/> is null or invalid</exception>
		public static void IndexMax<TInd>(Storage<TInd> array, out TInd max) where TInd : unmanaged;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="array"/> is null or invalid</exception>
		public static void IndexMin<TInd>(Storage<TInd> array, out TInd min) where TInd : unmanaged;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="array"/> is null or invalid</exception>
		public static void IndexFind<TInd>(Storage<TInd> array, TInd value, out long find) where TInd : unmanaged;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="NullReferenceException">If <paramref name="array"/> is null or invalid</exception>
		public static void IndexBound<TInd>(Storage<TInd> array, TInd value, bool lowerBound, out long index) where TInd : unmanaged;
		#endregion
		#endregion
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		protected abstract bool VectorSparseAddSparse_<T>(ISparseVector<T> x, ISparseVector<T> y, ISparseVector<T> target, SparseVectorFormat format = FormatExtension.VectorAny, DelegateCreateMatrixNew<T>? createFunc = null) where T : unmanaged;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> or <paramref name="M"/> is null or invalid</exception>
		protected abstract bool MatrixDenseMultiplyVectorSparse_<T>(MatrixOperation op, T α, long m, long n, Storage<T> M, ISparseVector<T> x, T β, Storage<T> y) where T : unmanaged, IEquatable<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> or <paramref name="M"/> is null or invalid</exception>
		/// <exception cref="ArgumentException">If <paramref name="M"/> has wrong number of non-zero elements</exception>
		protected abstract bool VectorSparseOuter_<T>(bool conjY, T α, ISparseVector<T> x, ISparseVector<T> y, T β, ISparseMatrix<T> M) where T : unmanaged, IEquatable<T>;
		#endregion
		...
		protected abstract bool IndexMinMax_<TInd>(Storage<TInd> array, out TInd min, out TInd max) where TInd : unmanaged;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="array"/> is null or invalid</exception>
		protected abstract bool IndexFind_<TInd>(Storage<TInd> array, TInd value, out long find) where TInd : unmanaged;
