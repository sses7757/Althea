...
namespace Althea.LinearAlgebra.Dense
{
	...
	public abstract partial class AbstractApi : AbstractApiSelector
	{
		...
		public static void GeneralMatricesAdd<T>(MatrixOperation opA, MatrixOperation opB, long m, long n, T α, Storage<T>? A, long lda, T β, Storage<T>? B, long ldb, Storage<T> C, long ldc) where T : unmanaged, INumber<T>
		{
...
#pragma warning restore CS8602
		...
		public static void DiagonalMatrixMultiplyGeneral<T>(bool leftA, long m, long n, T α, Storage<T> A, long lda, Storage<T> x, int strideX, T β, Storage<T> C, long ldc) where T : unmanaged, INumber<T>
		{
		...
		public static void PointWisePower<T>(Storage<T> x, int stride, double p) where T : unmanaged, INumber<T>
		{
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		public static void PointWisePower<T>(Storage<T> x, int stride, T p) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		public static void PointWiseConjugate<T>(Storage<T> x, int stride) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		public static void TruncateArray<T>(Storage<T> x, int stride, double threshold) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		public static T AggregateSum<T>(Storage<T> x, int stride) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription;
			T result = default;
			bool success = false;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		public static T AggregateProduct<T>(Storage<T> x, int stride) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription;
			T result = default;
			bool success = false;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		public static void PointWiseAddScalar<T>(Storage<T> x, int stride, T scalar) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		public static bool PointWiseEquals<T>(Storage<T> x, int strideX, Storage<T> y, int strideY) where T : unmanaged, INumber<T>
		{
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		public static void PointWiseMultiply<T>(Storage<T> x, int strideX, Storage<T> y, int strideY) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription, location2 = y.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		public static void PointWiseDivide<T>(Storage<T> x, int strideX, Storage<T> y, int strideY) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription, location2 = y.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		public static void PointWiseCast<T, TOut>(Storage<T> source, int strideSrc, Storage<TOut> destination, int strideDst) where T : unmanaged, INumber<T> where TOut : unmanaged
		{
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		public static void PartialSum<T>(Storage<T> x, int strideX, Storage<T> y, int strideY, bool inclusive) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription, location2 = y.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		public static void PartialProduct<T>(Storage<T> x, int strideX, Storage<T> y, int strideY, bool inclusive) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = x.LocationDescription, location2 = y.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		public static void MatrixCopyUpperLowerParts<T>(bool storedUpper, bool hermitian, long n, Storage<T> A, long lda) where T : unmanaged, INumber<T>
		{
		...
		/// <exception cref="InvalidOperationException">If an error occurred during selecting the implementation</exception>
		/// <exception cref="ArgumentNullException">If <paramref name="A"/> is null or invalid</exception>
		public static void MatrixClearUpperLowerPart<T>(bool clearLower, long n, Storage<T> A, long lda) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = A.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		public static void MatrixKronecker<T>(long ma, long na, long mb, long nb, T α, Storage<T> A, long lda, Storage<T> B, long ldb, T β, Storage<T> C, long ldc) where T : unmanaged, INumber<T>
		{
			CombinationOfLocations location1 = A.LocationDescription, location2 = B.LocationDescription, location3 = C.LocationDescription;
			bool success = false;
			LinkedListNode<AbstractApi>? node = null;
		...
		protected abstract bool GeneralMatricesAdd_<T>(MatrixOperation opA, MatrixOperation opB, long m, long n, T α, Storage<T>? A, long lda, T β, Storage<T>? B, long ldb, Storage<T> C, long ldc) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="A"/> or <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> ≤ 0</exception>
		protected abstract bool DiagonalMatrixMultiplyGeneral_<T>(bool leftA, long m, long n, T α, Storage<T> A, long lda, Storage<T> x, int strideX, T β, Storage<T> C, long ldc) where T : unmanaged, INumber<T>;
		#endregion
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		protected abstract bool PointWiseEquals_<T>(Storage<T> x, int strideX, Storage<T> y, int strideY, out bool equals) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		protected abstract bool PointWiseMultiply_<T>(Storage<T> x, int strideX, Storage<T> y, int strideY) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> or <paramref name="y"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		protected abstract bool PointWiseDivide_<T>(Storage<T> x, int strideX, Storage<T> y, int strideY) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		protected abstract bool PointWisePower_<T>(Storage<T> x, int stride, double p) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		protected abstract bool PointWisePower_<T>(Storage<T> x, int stride, T p) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		protected abstract bool PointWiseConjugate_<T>(Storage<T> x, int stride) where T : unmanaged, INumber<T>;
		...
		protected abstract bool PointWiseCast_<T, TOut>(Storage<T> source, int incSrc, Storage<TOut> destination, int incDst) where T : unmanaged, INumber<T> where TOut : unmanaged;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		protected abstract bool TruncateArray_<T>(Storage<T> x, int stride, double threshold) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		protected abstract bool AggregateSum_<T>(Storage<T> x, int stride, out T sum) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		protected abstract bool AggregateProduct_<T>(Storage<T> x, int stride, out T product) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		protected abstract bool PartialSum_<T>(Storage<T> x, int strideX, Storage<T> y, int strideY, bool inclusive) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="strideX"/> or <paramref name="strideY"/> is less than 1</exception>
		protected abstract bool PartialProduct_<T>(Storage<T> x, int strideX, Storage<T> y, int strideY, bool inclusive) where T : unmanaged, INumber<T>;
		...
		/// <exception cref="ArgumentNullException">If <paramref name="x"/> is null or invalid</exception>
		/// <exception cref="ArgumentOutOfRangeException">If <paramref name="stride"/> is less than 1</exception>
		protected abstract bool PointWiseAddScalar_<T>(Storage<T> x, int stride, T scalr) where T : unmanaged, INumber<T>;
		#endregion
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="A"/> is null or invalid</exception>
		protected abstract bool MatrixCopyUpperLowerParts_<T>(bool storedUpper, bool hermitian, long n, Storage<T> A, long lda) where T : unmanaged, INumber<T>;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="A"/> is null or invalid</exception>
		protected abstract bool MatrixClearUpperLowerPart_<T>(bool clearLower, long n, Storage<T> A, long lda) where T : unmanaged, INumber<T>;
		...
		/// <returns>Whether this implementation supports the given parameters or not. If false, further internal operation is not allowed.</returns>
		/// <exception cref="ArgumentNullException">If <paramref name="A"/> or <paramref name="B"/> or <paramref name="C"/> is null or invalid</exception>
		protected abstract bool MatrixKronecker_<T>(long ma, long na, long mb, long nb, T α, Storage<T> A, long lda, Storage<T> B, long ldb, T β, Storage<T> C, long ldc) where T : unmanaged, INumber<T>;
		#endregion
		#endregion
	}
}
