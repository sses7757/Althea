...
public struct FixedClassBuffer_2<T> : IEqualityOperators<FixedClassBuffer_2<T>, FixedClassBuffer_2<T>, bool>, IReadOnlyList<T>, IAsSpan<T> where T : class
{
	...
	public T this[int index]
	{
		...
		get
		{
			return Unsafe.Add(ref Unsafe.As<FixedClassBuffer_2<T>, T>(ref this), index);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		set
		{
			Unsafe.Add(ref Unsafe.As<FixedClassBuffer_2<T>, T>(ref this), index) = value;
		}
	}
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public override bool Equals(object? obj) => obj is FixedClassBuffer_2<T> buffer && this.Equals(buffer);
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator ==(FixedClassBuffer_2<T> left, FixedClassBuffer_2<T> right) => left.Equals(right);
	...
	{
		return $"FixedClasstypeBuffer {{ Size = 2, Type = {typeof(T).GetGenericString()} }}";
	}
	#endregion
}
...
public struct FixedClassBuffer_4<T> : IEqualityOperators<FixedClassBuffer_4<T>, FixedClassBuffer_4<T>, bool>, IReadOnlyList<T>, IAsSpan<T> where T : class
{
	...
	/// <summary>
	/// Create a <see cref="FixedClassBuffer_4{T}"/> with a given <paramref name="array"/>
	/// </summary>
	/// <param name="array">The given array of <typeparamref name="T"/> used to create</param>
	/// <exception cref="ArgumentException">If the size of <paramref name="array"/> is larger than 4</exception>
	/// <exception cref="ArgumentNullException">If <paramref name="array"/> is null</exception>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public FixedClassBuffer_4(params T[] array)
	{
		if (array is null || array.Length == 0)
			throw new ArgumentNullException(nameof(array));
		array.CopyTo(this.AsSpan());
	...
	/// <summary>
	/// Create a <see cref="FixedClassBuffer_4{T}"/> with a given <paramref name="span"/>
	/// </summary>
	/// <param name="span">The given <see cref="ReadOnlySpan{T}"/> of <typeparamref name="T"/> used to create</param>
	/// <exception cref="ArgumentException">If the size of <paramref name="span"/> is larger than 4</exception>
	/// <exception cref="ArgumentNullException">If <paramref name="span"/> is empty</exception>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public FixedClassBuffer_4(ReadOnlySpan<T> span)
	{
		if (span.IsEmpty)
			throw new ArgumentNullException(nameof(span));
		span.CopyTo(this.AsSpan(), static s => s);
	...
	public T this[int index]
	{
		...
		get
		{
			return Unsafe.Add(ref Unsafe.As<FixedClassBuffer_4<T>, T>(ref this), index);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		set
		{
			Unsafe.Add(ref Unsafe.As<FixedClassBuffer_4<T>, T>(ref this), index) = value;
		}
	}
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public bool Equals(FixedClassBuffer_4<T> other)
	{
		var comparer = EqualityComparer<T>.Default;
		return this.AsSpan().SequenceEqual<T, T>(other.AsSpan(), (a, b) => comparer.Equals(a, b));
	}
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public override bool Equals(object? obj) => obj is FixedClassBuffer_4<T> buffer && this.Equals(buffer);
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator ==(FixedClassBuffer_4<T> left, FixedClassBuffer_4<T> right) => left.Equals(right);
	...
	public override string ToString()
	{
		return $"FixedClasstypeBuffer {{ Size = 4, Type = {typeof(T).GetGenericString()} }}";
	}
	#endregion
}
...
public struct FixedClassBuffer_8<T> : IEqualityOperators<FixedClassBuffer_8<T>, FixedClassBuffer_8<T>, bool>, IReadOnlyList<T>, IAsSpan<T> where T : class
{
	...
	public T this[int index]
	{
		...
		get
		{
			return Unsafe.Add(ref Unsafe.As<FixedClassBuffer_8<T>, T>(ref this), index);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		set
		{
			Unsafe.Add(ref Unsafe.As<FixedClassBuffer_8<T>, T>(ref this), index) = value;
		}
	}
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public override bool Equals(object? obj) => obj is FixedClassBuffer_8<T> buffer && this.Equals(buffer);
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator ==(FixedClassBuffer_8<T> left, FixedClassBuffer_8<T> right) => left.Equals(right);
	...
	public override string ToString()
	{
		return $"FixedClasstypeBuffer {{ Size = 8, Type = {typeof(T).GetGenericString()} }}";
	}
	#endregion
}
...
public struct FixedClassBuffer_16<T> : IEqualityOperators<FixedClassBuffer_16<T>, FixedClassBuffer_16<T>, bool>, IReadOnlyList<T>, IAsSpan<T> where T : class
{
	...
	public T this[int index]
	{
		...
		get
		{
			return Unsafe.Add(ref Unsafe.As<FixedClassBuffer_16<T>, T>(ref this), index);
		}
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		set
		{
			Unsafe.Add(ref Unsafe.As<FixedClassBuffer_16<T>, T>(ref this), index) = value;
		}
	}
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public override bool Equals(object? obj) => obj is FixedClassBuffer_16<T> buffer && this.Equals(buffer);
	...
	/// <inheritdoc/>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static bool operator ==(FixedClassBuffer_16<T> left, FixedClassBuffer_16<T> right) => left.Equals(right);
	...
	public override string ToString()
	{
		return $"FixedClasstypeBuffer {{ Size = 16, Type = {typeof(T).GetGenericString()} }}";
	}
	#endregion
}
