...
namespace Althea.Helpers
{
	...
	public struct FixedClassBuffer_4<T> : IEqualityOperators<FixedClassBuffer_4<T>, FixedClassBuffer_4<T>>, IReadOnlyList<T>, IAsSpan<T> where T : class
	{
		...
		/// Whether this == <paramref name="other"/>
		/// </summary>
		/// <param name="other">another <see cref="FixedClassBuffer_4{T}"/> to compare</param>
		/// <returns>this == <paramref name="other"/></returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		...
		public override bool Equals(object? obj)
		{
			return obj is FixedClassBuffer_4<T> buffer && this.Equals(buffer);
		}

		/// <summary>
		/// Override <see cref="ValueType.GetHashCode"/> to get the hash code this <see cref="FixedClassBuffer_4{T}"/>.
		/// </summary>
		/// <returns>The hash code</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public override int GetHashCode()
		...
		/// </summary>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static bool operator ==(FixedClassBuffer_4<T> left, FixedClassBuffer_4<T> right)
		{
			return left.Equals(right);
		}
		...
		#region string related
		/// <summary>
		/// Return the string representation of this <see cref="FixedClassBuffer_4{T}"/>
		/// </summary>
		/// <returns>the string representation of this <see cref="FixedClassBuffer_4{T}"/></returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public override string ToString()
		{
			return $"Fixed Class-type Buffer [Size=4, Type={typeof(T).GetGenericString()}]";
		}
		#endregion
	}
	/// <summary>
