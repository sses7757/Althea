...
public static class SpanLinq
{
	...
	{
		((ReadOnlySpan<TIn>)span).CopyTo(array, selector);
	}
	...
	{
		((ReadOnlySpan<TIn1>)span1).Zip(span2, array, selector);
	}
	...
	public static T Max<T>(this Span<T> span) where T : IComparisonOperators<T, T, bool>
	{
		return ((ReadOnlySpan<T>)span).Max();
	}
	...
	/// <param name="span">The span to find maximum</param>
	/// <returns>The maximum item</returns>
	public static T Max<T>(this ReadOnlySpan<T> span) where T : IComparisonOperators<T, T, bool>
	{
		T maxVal = span[0];
		int len = span.Length;
		for (int i = 1; i < len; i++)
	...
	public static T Min<T>(this Span<T> span) where T : IComparisonOperators<T, T, bool>
	{
		return ((ReadOnlySpan<T>)span).Min();
	}
	...
	/// <param name="span">The span to find minimum</param>
	/// <returns>The minimum item</returns>
	public static T Min<T>(this ReadOnlySpan<T> span) where T : IComparisonOperators<T, T, bool>
	{
		T minVal = span[0];
		int len = span.Length;
		for (int i = 1; i < len; i++)
	...
	/// <returns>The maximum item</returns>
	public static T Max<TOrg, T>(this Span<TOrg> span, Converter<TOrg, T> selector) where T : IComparisonOperators<T, T, bool>
	{
		return ((ReadOnlySpan<TOrg>)span).Max(selector);
	}
	...
	/// <param name="selector">The selector to apply to each element of <paramref name="span"/></param>
	/// <returns>The maximum item</returns>
	public static T Max<TOrg, T>(this ReadOnlySpan<TOrg> span, Converter<TOrg, T> selector) where T : IComparisonOperators<T, T, bool>
	{
	...
	/// <param name="selector">The selector to apply to each element of <paramref name="span"/></param>
	/// <returns>The minimum item</returns>
	public static T Min<TOrg, T>(this Span<TOrg> span, Converter<TOrg, T> selector) where T : IComparisonOperators<T, T, bool>
	{
		return ((ReadOnlySpan<TOrg>)span).Min(selector);
	}
	...
	/// <param name="selector">The selector to apply to each element of <paramref name="span"/></param>
	/// <returns>The minimum item</returns>
	public static T Min<TOrg, T>(this ReadOnlySpan<TOrg> span, Converter<TOrg, T> selector) where T : IComparisonOperators<T, T, bool>
	{
	...
	{
		((ReadOnlySpan<T>)array).ReOrderTo(target, indices);
	}
	...
	{
		((ReadOnlySpan<T>)array).InverseOrderTo(target, indices);
	}
	...
	{
		return ((ReadOnlySpan<T>)array).FindPermutationTo(target, perm);
	}
	...
	{
		((ReadOnlySpan<int>)perm).InversePermutationTo(inv);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).AccumulateSum(result, init, inclusive);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).AccumulateProd(result, init, inclusive);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).Sum();
	}
	...
	{
		return ((ReadOnlySpan<T>)span).Prod();
	}
	...
	{
		return ((ReadOnlySpan<TOrg>)span).Sum(selector);
	}
	...
	{
		return ((ReadOnlySpan<TOrg>)span).Prod(selector);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).AndAll();
	}
	...
	{
		return ((ReadOnlySpan<T>)span).OrAll();
	}
	#endregion
	...
	{
		return ((ReadOnlySpan<T>)span).IndexOf(predicator);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).IndexOf(value, comparer);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).LastIndexOf(predicator);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).LastIndexOf(value, comparer);
	}
	...
	{
		return ((ReadOnlySpan<T>)sortedSpan).LowerBound(value);
	}
	...
	{
		return ((ReadOnlySpan<T>)sortedSpan).UpperBound(value);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).FastAllZeros();
	}
	...
	{
		return ((ReadOnlySpan<T>)span).AllZeros();
	}
	...
	{
		return ((ReadOnlySpan<T>)span).AllSame();
	}
	...
	{
		return ((ReadOnlySpan<T>)span).All(predicator);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).Any(predicator);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).AnyNonPositive();
	}
	...
	{
		return ((ReadOnlySpan<TL>)span).SequenceEqual(other, equalityComparer);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).SequenceLargerEqualThan(other);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).FirstOrDefault(predicate);
	}
	...
	{
		return ((ReadOnlySpan<T>)span).HashCodeOfSpan();
	}
	...
	{
		return ((ReadOnlySpan<T>)span).ElementsUnique();
	}
	...
	{
		return ((ReadOnlySpan<T>)set).HashCodeOfSet();
	}
	...
	{
		return ((ReadOnlySpan<T>)span).DistinctCount();
	}
	...
	{
		return ((ReadOnlySpan<T>)set).SetExept(except, output);
	}
	...
	{
		return ((ReadOnlySpan<T>)set).FirstOfSetExept(except);
	}
	...
	{
		return ((ReadOnlySpan<T>)set1).SetIntersect(set2, output);
	}
	...
	{
		return ((ReadOnlySpan<T>)set1).SetIntersectIndex(set2, outpuIndex);
	}
	...
	{
		return ((ReadOnlySpan<T>)set1).SetIntersectWithIndex(set2, ref output, ref outpuIndex);
	}
	...
	{
		return ((ReadOnlySpan<T>)set1).SetUnion(set2, output);
	}
	...
	{
		return ((ReadOnlySpan<T>)set1).SetEquals(set2);
	}
	...
	{
		((ReadOnlySpan<T>)span).ForEach(action);
	}
