...
namespace Althea.Helpers
{
	...
	public unsafe struct FixedBuffer_12<T> : IEquatable<FixedBuffer_12<T>>, IFixedBuffer<T>, IAsSpan<T> where T : unmanaged, IEquatable<T>
	{
		#region basic
	...
	[DebuggerTypeProxy(typeof(FixedBufferDebugView<>))]
	[DebuggerDisplay("{ToString(),raw}")]
	public unsafe struct FixedBuffer_8<T> : IEquatable<FixedBuffer_8<T>>, IFixedBuffer<T>, IAsSpan<T> where T : unmanaged, IEquatable<T>
	{
		#region basic
	...
	[DebuggerTypeProxy(typeof(FixedBufferDebugView<>))]
	[DebuggerDisplay("{ToString(),raw}")]
	public unsafe struct FixedBuffer_16<T> : IEquatable<FixedBuffer_16<T>>, IFixedBuffer<T>, IAsSpan<T> where T : unmanaged, IEquatable<T>
	{
		#region basic
	...
	[DebuggerTypeProxy(typeof(FixedBufferDebugView<>))]
	[DebuggerDisplay("{ToString(),raw}")]
	public unsafe struct FixedBuffer_32<T> : IEquatable<FixedBuffer_32<T>>, IFixedBuffer<T>, IAsSpan<T> where T : unmanaged, IEquatable<T>
	{
		#region basic
	...
	[DebuggerTypeProxy(typeof(FixedBufferDebugView<>))]
	[DebuggerDisplay("{ToString(),raw}")]
	public unsafe struct FixedBuffer_64<T> : IEquatable<FixedBuffer_64<T>>, IFixedBuffer<T>, IAsSpan<T> where T : unmanaged, IEquatable<T>
	{
		#region basic
	...
	[DebuggerTypeProxy(typeof(FixedBufferDebugView<>))]
	[DebuggerDisplay("{ToString(),raw}")]
	public unsafe struct FixedBuffer_128<T> : IEquatable<FixedBuffer_128<T>>, IFixedBuffer<T>, IAsSpan<T> where T : unmanaged, IEquatable<T>
	{
		#region basic
	...
	[DebuggerTypeProxy(typeof(FixedBufferDebugView<>))]
	[DebuggerDisplay("{ToString(),raw}")]
	public unsafe struct FixedBuffer_256<T> : IEquatable<FixedBuffer_256<T>>, IFixedBuffer<T>, IAsSpan<T> where T : unmanaged, IEquatable<T>
	{
		#region basic
