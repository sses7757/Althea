...
public static unsafe partial class NativeMethods
{
	...
	[LibraryImport(Cuda.NativeMethods.CUFFT_DLL_NAME)]
	internal static partial CudaFftStatus cufftXtMakePlanMany(int plan, int rank, Span<long> size, Span<long> inputOuterSize, long inputStride, long inputDistance, DataType inputtype, Span<long> outputOuterSize, long outputStride, long outputDistance, DataType outputtype, long batchSize, out long workSize, DataType executiontype);
